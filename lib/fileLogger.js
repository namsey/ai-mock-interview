 ...
 */
function formatLogEntry(level, context, message, data = null, meta = null) {
 ...
 */
function logError(context, message, error = null, data = null) {
  const entry = formatLogEntry('ERROR', context, message, error, data);
